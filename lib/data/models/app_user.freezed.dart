...
@override
String toString() {
  return 'AppUser(id: $id, name: $name, email: $email, university: $university, program: $program, gender: $gender, avatarUrl: $avatarUrl, isGuest: $isGuest)';
}
...
class _AppUser implements AppUser {
  const _AppUser({required this.id, required this.name, this.email, this.university, this.program, this.gender, this.avatarUrl, this.isGuest = true});
